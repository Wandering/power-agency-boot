$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '代理商角色', name: 'agencyrole', index: 'agencyrole', width: 80 }, 			
			{ label: '合同开始时间', name: 'contractStartdt', index: 'contract_startDt', width: 80 }, 			
			{ label: '合同结束时间', name: 'contractEnddt', index: 'contract_endDt', width: 80 }, 			
