...
//
////        MvcResult mvcResult = this.mvc.perform(get("/captcha.jpg").accept(MediaType.APPLICATION_JSON_UTF8))
////                .andExpect(status().isOk())
////                .andExpect(jsonPath("$.code").value(0)).andReturn();
////        ;
////        String captcha = (String) ShiroUtils.getSession().getAttribute(Constants.KAPTCHA_SESSION_KEY);
//
